...
private:
  ...
  float ow,ox,oy,oz,px,py,pz = 0.0;
};
...
{
  node_->get_parameter<float>("ow", ow);
  node_->get_parameter<float>("ox", ox);
  node_->get_parameter<float>("oy", oy);
  node_->get_parameter<float>("oz", oz);

  node_->get_parameter<float>("px", px);
  node_->get_parameter<float>("py", py);
  node_->get_parameter<float>("pz", pz);
}
